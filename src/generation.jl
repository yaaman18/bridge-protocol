...
"""
    check_proliferation_morphism(; parent_viable=true, child_viable=true,
        heritage_lax=true, branch_transport=true, inverse_translation=false)
...
function check_proliferation_morphism(;
    ...
    parent_viable && child_viable && heritage_lax && branch_transport && !inverse_translation
end
...
function check_lineage_stays_open(;
    ...
    cofinal && semantic_invariant && !asserts_eventual_periodicity
end
...
function check_richness_inherits_generational(;
    ...
    proliferation_morphism && parent_branch && child_branch_transport && child_pump
end
