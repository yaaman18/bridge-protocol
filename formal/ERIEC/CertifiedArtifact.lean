...
structure CertifiedContract where
  ...
  leanModule : String
  leanName : String
  leanFullName : String := leanModule ++ "." ++ leanName
  leanKind : String
  juliaSymbol : String
  juliaChecker : String
    ...
    contracts := [
      {
        ...
        leanName := "ERIESystem"
        leanFullName := "ERIEC.Adj.ERIESystem"
        leanKind := "structure"
      ...
      },
      {
        ...
        leanFullName := "ERIEC.Adj.rigidity_of_gc"
        leanKind := "theorem"
        juliaSymbol := "ERIEStructure"
        juliaChecker := "check_relational_rigidity"
      },
      {
        id := "adjunction.galois_conn"
        leanModule := "ERIEC.Adjunction"
        leanName := "galoisConn_induced"
        leanFullName := "ERIEC.Adj.galoisConn_induced"
        leanKind := "theorem"
        juliaSymbol := "check_K3"
        juliaChecker := "check_K3"
      },
      {
      ...
      },
      {
        ...
        leanFullName := "ERIEC.Sens.dualSymmetry"
        leanKind := "theorem"
      ...
      },
      {
        ...
        leanFullName := "ERIEC.Sens.not_id_le_adjoint_comp"
        leanKind := "theorem"
        juliaSymbol := "sensitivity_tensor"
      ...
      },
      {
        ...
        leanFullName := "ERIEC.WorldDC.wldNontrivial_of_intertwining"
        leanKind := "theorem"
        juliaSymbol := "-"
        juliaChecker := "-"
      },
      ...
      },
      {
        ...
        leanName := "Lineage"
        leanFullName := "ERIEC.OpenEvolution.Lineage"
        leanKind := "structure"
      ...
      },
      {
        ...
        leanFullName := "ERIEC.RefModel.rich_lineage_reference_model"
        leanKind := "theorem"
      ...
      },
      {
        ...
        leanFullName := "ERIEC.RefModel.branched_rich_lineage_reference_model"
        leanKind := "theorem"
      ...
      },
      {
        ...
        leanFullName := "ERIEC.TemporalDC.Certification.ObservedTerminationStep"
        leanKind := "def"
      ...
      },
      {
        ...
        leanFullName := "ERIEC.TemporalDC.Certification.PermanentTerminationStep"
        leanKind := "def"
      ...
      },
      {
        ...
        leanFullName := "ERIEC.RefModel.collapse_trace_reference_model"
        leanKind := "theorem"
      ...
      },
      {
        ...
        leanFullName := "ERIEC.RefModel.collapse_trace_precarious"
        leanKind := "theorem"
      ...
      },
      {
        ...
        leanFullName := "ERIEC.RefModel.all_mortal_reference_model"
        leanKind := "theorem"
      ...
      },
      {
        ...
        leanFullName := "ERIEC.OpenSimC.Hom.mapPath_id_comp"
        leanKind := "theorem"
        juliaSymbol := "-"
        juliaChecker := "-"
      },
      ...
      },
      {
        ...
        leanFullName := "ERIEC.RefModelV52.SymmetricDouble.dcAt_zero_center_indistinguishable"
        leanKind := "theorem"
        juliaSymbol := "-"
        juliaChecker := "-"
      },
      ...
      },
      {
        ...
        leanFullName := "ERIEC.RefModelV52.SymmetricDouble.positiveValue_swapped"
        leanKind := "theorem"
        juliaSymbol := "-"
        juliaChecker := "-"
      },
      {
        ...
        leanFullName := "ERIEC.RefModelV52.SymmetricDouble.euclideanMarkerConscious_horizontal_wall"
        leanKind := "theorem"
        juliaSymbol := "-"
        juliaChecker := "-"
      },
      {
        ...
        leanFullName := "ERIEC.RefModelV52.SymmetricDouble.analytic_fm4_swapped"
        leanKind := "theorem"
        juliaSymbol := "-"
        juliaChecker := "-"
      },
      {
        ...
        leanFullName := "ERIEC.RefModelV52.SymmetricDouble.euclidean_hilbert_fm4_swapped"
        leanKind := "theorem"
        juliaSymbol := "-"
        juliaChecker := "-"
      },
      {
        ...
        leanFullName := "ERIEC.RefModelV52.SymmetricDouble.complex_hilbert_fm4_swapped"
        leanKind := "theorem"
        juliaSymbol := "-"
        juliaChecker := "-"
      },
      {
        ...
        leanFullName := "ERIEC.RefModelV52.SymmetricDouble.symmetric_double_complete"
        leanKind := "theorem"
        juliaSymbol := "-"
        juliaChecker := "-"
      },
      {
        ...
        leanFullName := "ERIEC.RefModelV52.SymmetricDouble.markerStep_terminal"
        leanKind := "theorem"
        juliaSymbol := "-"
        juliaChecker := "-"
      },
      {
        ...
        leanFullName := "ERIEC.RefModelV52.SymmetricDouble.markerStep_exchange_iff"
        leanKind := "theorem"
        juliaSymbol := "-"
        juliaChecker := "-"
      },
      {
        ...
        leanFullName := "ERIEC.RefModelV52.SymmetricDouble.alpha_sigma_converse"
        leanKind := "theorem"
        juliaSymbol := "-"
        juliaChecker := "-"
      },
      {
        ...
        leanFullName := "ERIEC.RefModelV52.SymmetricDouble.euclideanSpectralProjection_eq_id"
        leanKind := "theorem"
        juliaSymbol := "-"
        juliaChecker := "-"
      },
      {
        ...
        leanFullName := "ERIEC.RefModelV52.SymmetricDouble.symmetric_double_dynamic_conjugacy"
        leanKind := "theorem"
        juliaSymbol := "-"
        juliaChecker := "-"
      },
      {
        ...
        leanFullName := "ERIEC.RefModelV52.SymmetricDouble.collapse_initial_trajectory_swap_invariant"
        leanKind := "theorem"
        juliaSymbol := "-"
        juliaChecker := "-"
      },
      ...
      },
      {
        ...
        leanFullName := "ERIEC.RefModelV52.SymmetricDouble.euclideanMarker_fm4_iff"
        leanKind := "theorem"
        juliaSymbol := "-"
        juliaChecker := "-"
      },
      ...
      },
      {
        ...
        leanFullName := "ERIEC.RefModelV52.SymmetricDouble.collapseDynamicIso"
        leanKind := "def"
        juliaSymbol := "-"
        juliaChecker := "-"
      },
      {
        ...
        leanFullName := "ERIEC.RefModelV52.SymmetricDouble.collapse_update_iterate_swap_commutes"
        leanKind := "theorem"
        juliaSymbol := "-"
        juliaChecker := "-"
      },
      {
        ...
        leanFullName := "ERIEC.RefModelV52.SymmetricDouble.symmetricDoubleCompleteWitness"
        leanKind := "def"
        juliaSymbol := "-"
        juliaChecker := "-"
      },
      ...
      },
      {
        ...
        leanFullName := "ERIEC.RefModelV52.SymmetricDouble.euclideanMarkerBlind_horizontal_wall"
        leanKind := "theorem"
        juliaSymbol := "-"
        juliaChecker := "-"
      },
      {
        ...
        leanFullName := "ERIEC.RefModelV52.SymmetricDouble.euclideanMarker_blind_false"
        leanKind := "theorem"
        juliaSymbol := "-"
        juliaChecker := "-"
      },
      {
        ...
        leanFullName := "ERIEC.RefModelV52.SymmetricDouble.euclideanMarker_not_conscious_false"
        leanKind := "theorem"
        juliaSymbol := "-"
        juliaChecker := "-"
      },
      {
        ...
        leanModule := "ERIEC.RefModelV52"
        leanName := "fm1_false"
        leanFullName := "ERIEC.RefModelV52.SymmetricDouble.fm1_false"
        leanKind := "theorem"
        juliaSymbol := "-"
        juliaChecker := "-"
      },
      {
        ...
        leanFullName := "ERIEC.RefModelV52.SymmetricDouble.symmetricDouble_realizationMultiplicity_nonisomorphic"
        leanKind := "theorem"
        juliaSymbol := "-"
        juliaChecker := "-"
      },
      {
        ...
        leanModule := "ERIEC.NonDegenerateRecur"
        leanName := "fullWitness_has_recur"
        leanFullName := "ERIEC.NonDegenerateRecur.fullWitness_has_recur"
        leanKind := "theorem"
        juliaSymbol := "-"
        juliaChecker := "-"
      },
      {
        ...
        leanFullName := "ERIEC.RefModelV52.NonDegenerateRecur.integratedWitness_has_recur"
        leanKind := "theorem"
        juliaSymbol := "-"
        juliaChecker := "-"
      },
      {
        ...
        leanFullName := "ERIEC.RefModelV52.SymmetricDouble.horizontalWallWitness_indistinguishable"
        leanKind := "theorem"
        juliaSymbol := "-"
        juliaChecker := "-"
      }
